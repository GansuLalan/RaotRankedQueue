...
TOKEN = 'ODg0ODcwNDgxNzM0NDI2Njg0.GRBtPn.SIDGHT_QfVxhGZtME4cUocbAUj-0P44MxAplA0'
intents = nextcord.Intents().all()
Queue = ['brewskii',
      'aris',
      'madz',
      'tropic']
class aclient(nextcord.commands.Bot(command_prefix='-', intents=intents)):
    def __init__(self):
    ...
    async def on_ready(self):
        ...
        if not self.synced:
            await setup.sync(guild=nextcord.Object(id=nextcord.utils.get(client.guilds, name="guild's name").id))
            self.synced = True
        if not self.added:
...
async def setup(ctx):
    ...
    embed.set_image(url='https://cdn.discordapp.com/attachments/994225283496431639/994344182544080956/Ranked_Guide.png')
    embed.set_thumbnail(url='https://cdn.discordapp.com/attachments/994225283496431639/994346170149257348/Insane4.png')
    embed.set_author(name='RAoT Competitive Official',
                     icon_url='https://cdn.discordapp.com/icons/876201792457801758/237d8502b900233ddcfadd4e5111b6f3.png')
